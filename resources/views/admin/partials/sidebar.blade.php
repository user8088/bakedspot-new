...
<div class="col-md-2 sidebar sticky-top shadow mt-3 d-none d-lg-block" id="sidebar-desktop">
    ...
    <nav class="nav flex-column">
        <a class="nav-link p-2" href="{{route('admin.dashboard')}}"><img src="{{ asset('icons/dashboard-icon.png') }}" class="img-fluid" alt="Dashboard" width="20" height="20" /><span class="ps-3 dashboard-text">Dashboard</span></a>
        ...
        <a class="nav-link p-2" href="{{route('admin.orders.index')}}"><img src="{{ asset('icons/stock-managment-icon.png') }}" class="img-fluid" alt="Stock Management" width="20" height="20" /><span class="ps-3 dashboard-text">Order Management</span></a>
