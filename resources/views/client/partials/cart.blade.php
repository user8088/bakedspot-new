    ...
    <div class="offcanvas-body">
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        @elseif($orderType == 'pickup' && !$selectedTimeSlot)
                            <div class="alert alert-warning mt-3 py-2 small">
                                <i class="fas fa-exclamation-triangle me-2"></i>
                                Please <a href="{{ route('pickup.time_selection') }}" class="alert-link">select a pickup time</a> to continue.
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="mt-4">
            @if(isset($cartItems) && count($cartItems) > 0)
                ...
                @else
                    <a href="{{ route('pickup.time_selection') }}" class="btn btn-main w-100">Select Pickup Time</a>
                @endif
            @else
...
<script>
    ...
    function updateCartHTML(response) {
        ...
        if (!response.cartItems || response.cartItems.length === 0) {
            ...
            // Add delivery or pickup info based on order type
